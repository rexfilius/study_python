# Some objects define standard clean-up actions to be undertaken when the object is
# no longer needed, regardless of whether or not the operation using the object
# succeeded or failed.

# Look at the following example, which tries to open a file and print its contents
# to the screen.
for line in open("our_file.txt"):
    print(line, end="")
...
# After the statement is executed, the file is always closed, even if a problem was
# encountered while processing the lines. Objects which, like files,
