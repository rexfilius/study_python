...
Wrap lines so that they don't exceed 79 characters. This helps users with small displays
and makes it possible to have several code files side-by-side on larger displays.
...
environments. Python's default, UTF-8, or even plain ASCII work best in any case.
